...
"[project]/.next-internal/server/app/api/orders/seller/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
...
"[project]/src/app/api/orders/seller/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const filteredOrders = orders.map((order)=>({
                ...order,
                items: order.items.filter((item)=>item.seller._id.toString() === decoded.userId),
                // Recalculate total for seller's items only
                totalAmount: order.items.filter((item)=>item.seller._id.toString() === decoded.userId).reduce((sum, item)=>sum + item.subtotal, 0)
            }));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            data: filteredOrders
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0e756954._.js.map