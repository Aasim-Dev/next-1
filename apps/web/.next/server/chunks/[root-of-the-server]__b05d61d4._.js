...
async function POST(request) {
    try {
        ...
        // ✅ Validate input
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$validations$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["loginSchema"].validate(body);
        ...
        response.cookies.set('token', token, {
            httpOnly: true,
            secure: ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : false,
            sameSite: 'lax',
            maxAge: 7 * 24 * 60 * 60,
            path: '/'
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__b05d61d4._.js.map